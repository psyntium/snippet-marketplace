...
testparams = {
    "username": "SANDBOX_PERSONALITY_INSIGHTS_USERNAME",
    "password": "SANDBOX_PERSONALITY_INSIGHTS_PASSWORD",
    "version": "2017-10-13",
    ...
    nearly the same feelings towards the ocean with me. There now is your insular city of the \
    Manhattoes, belted round by wharves as Indian isles by coral reefs-commerce surrounds it with her \
