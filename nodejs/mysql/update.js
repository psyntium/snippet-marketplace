var testparams = {
    ...
    "student_id": "12345",
    "student_first_name": "John_updated",
    "student_last_name": "Doe_updated"
};
...
function main(params) {
    ...
    var query = "UPDATE " + params.tablename + " SET ? WHERE student_id = ?";
    var values = {
    ...
    return new Promise(function(resolve, reject) {
        pool.query(query, [values, params.student_id], function (err, data, fields) {
            pool.end();
