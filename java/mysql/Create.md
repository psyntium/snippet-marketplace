...
This code shows you how to use the Java API to create a new record in specified table in MySQL database. 
...
2. Lines 41-48 prepares the query and necessary params, and finally execute the query.

3. The result is returned in line 49, which show the status of success/failure creating the new record.
