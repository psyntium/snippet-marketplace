...
public class cognitive_visual_recognition {
	...
	public static void main(String[] args) {
		cognitive_visual_recognition test = new cognitive_visual_recognition();
		JsonObject arg = new JsonParser().parse(test.parameters).getAsJsonObject();
		System.out.println(cognitive_visual_recognition.main(arg));
	}
