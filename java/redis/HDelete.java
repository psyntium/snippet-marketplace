...
public class HDelete { 	 	
    ...
    public static JsonObject main(JsonObject args) { 	   
         ...
         Jedis client = new Jedis(redisConn.getAsJsonPrimitive("hostname").getAsString(), redisConn.getAsJsonPrimitive("port").getAsInt());
   		 ...
   		 String result = client.hdel(args.getAsJsonPrimitive("key").getAsString(), args.getAsJsonPrimitive("field").getAsString()).toString();
